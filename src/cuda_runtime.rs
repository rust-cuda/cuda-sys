...
pub enum cudaFuncAttribute {
    ...
    #[doc = "< Preferred shared memory-L1 cache split ratio"]
...
pub type cudaExternalMemory_t = *mut CUexternalMemory;
#[doc = " CUDA external semaphore"]
pub type cudaExternalSemaphore_t = *mut CUexternalSemaphore;
#[doc = " CUDA graph"]
...
extern "C" {
    ...
    #[doc = " actively spin on the processor."]
...
extern "C" {
    ...
    #[doc = " mode. The capture mode may be queried via ::cudaStreamIsCapturing."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " object."]
    #[doc = ""]
    #[doc = " Frees all buffers, CUDA arrays and CUDA mipmapped arrays that were"]
...
extern "C" {
    ...
    #[doc = " \\ref ::cudaSetupArgument(const void*, size_t, size_t) \"cudaSetupArgument (C API)\","]
...
extern "C" {
    ...
    #[doc = " - ::cudaFuncAttributeMaxDynamicSharedMemorySize - Maximum size of dynamic shared memory per block"]
    #[doc = " - ::cudaFuncAttributePreferredSharedMemoryCarveout - Preferred shared memory-L1 cache split ratio in percent of maximum shared memory"]
    #[doc = ""]
    ...
    #[doc = " ::cudaSetDoubleForDevice,"]
    #[doc = " ::cudaSetDoubleForHost,"]
    #[doc = " \\ref ::cudaSetupArgument(T, size_t) \"cudaSetupArgument (C++ API)\""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " \\sa"]
    #[doc = " \\ref ::cudaLaunch(const void*) \"cudaLaunch (C API)\","]
    #[doc = " \\ref ::cudaFuncSetCacheConfig(const void*, enum cudaFuncCache) \"cudaFuncSetCacheConfig (C API)\","]
    #[doc = " \\ref ::cudaFuncGetAttributes(struct cudaFuncAttributes*, const void*) \"cudaFuncGetAttributes (C API)\","]
    #[doc = " ::cudaSetDoubleForHost,"]
    #[doc = " \\ref ::cudaSetupArgument(const void*, size_t, size_t) \"cudaSetupArgument (C API)\""]
...
extern "C" {
    #[doc = " \\brief Configure a device-launch"]
    #[doc = ""]
    #[doc = " \\deprecated This function is deprecated as of CUDA 7.0"]
    #[doc = ""]
    #[doc = " Specifies the grid and block dimensions for the device call to be executed"]
    #[doc = " similar to the execution configuration syntax. ::cudaConfigureCall() is"]
    #[doc = " stack based. Each call pushes data on top of an execution stack. This data"]
    #[doc = " contains the dimension for the grid and thread blocks, together with any"]
    #[doc = " arguments for the call."]
    #[doc = ""]
    #[doc = " \\param gridDim   - Grid dimensions"]
    #[doc = " \\param blockDim  - Block dimensions"]
    #[doc = " \\param sharedMem - Shared memory"]
    #[doc = " \\param stream    - Stream identifier"]
    #[doc = ""]
    #[doc = " \\return"]
...
extern "C" {
    ...
    #[doc = " \\deprecated This function is deprecated as of CUDA 7.0"]
    #[doc = ""]
    #[doc = " Pushes \\p size bytes of the argument pointed to by \\p arg at \\p offset"]
    #[doc = " bytes from the start of the parameter passing area, which starts at"]
    #[doc = " offset 0. The arguments are stored in the top of the execution stack."]
    #[doc = " \\ref ::cudaSetupArgument(const void*, size_t, size_t) \"cudaSetupArgument()\""]
    #[doc = " must be preceded by a call to ::cudaConfigureCall()."]
    #[doc = ""]
    #[doc = " \\param arg    - Argument to push for a kernel launch"]
    #[doc = " \\param size   - Size of argument"]
    #[doc = " \\param offset - Offset in argument stack to push new arg"]
    #[doc = ""]
    #[doc = " \\return"]
    #[doc = " ::cudaSuccess"]
    #[doc = " \\notefnerr"]
...
extern "C" {
    ...
    #[doc = " \\deprecated This function is deprecated as of CUDA 7.0"]
    #[doc = ""]
    #[doc = " Launches the function \\p func on the device. The parameter \\p func must"]
    #[doc = " be a device function symbol. The parameter specified by \\p func must be"]
    #[doc = " declared as a \\p __global__ function. For templated functions, pass the"]
    #[doc = " function symbol as follows: func_name<template_arg_0,...,template_arg_N>"]
    #[doc = " \\ref ::cudaLaunch(const void*) \"cudaLaunch()\" must be preceded by a call to"]
    #[doc = " ::cudaConfigureCall() since it pops the data that was pushed by"]
    #[doc = " ::cudaConfigureCall() from the execution stack."]
    #[doc = ""]
    #[doc = " \\param func - Device function symbol"]
    #[doc = ""]
    #[doc = " \\return"]
    ...
    #[doc = " \\ref ::cudaFuncSetCacheConfig(const void*, enum cudaFuncCache) \"cudaFuncSetCacheConfig (C API)\","]
    #[doc = " \\ref ::cudaFuncGetAttributes(struct cudaFuncAttributes*, const void*) \"cudaFuncGetAttributes (C API)\","]
    #[doc = " \\ref ::cudaLaunch(T*) \"cudaLaunch (C++ API)\","]
    #[doc = " ::cudaSetDoubleForDevice,"]
    #[doc = " ::cudaSetDoubleForHost,"]
    #[doc = " \\ref ::cudaSetupArgument(const void*, size_t, size_t) \"cudaSetupArgument (C API)\","]
    #[doc = " ::cudaThreadGetCacheConfig,"]
...
extern "C" {
    ...
    #[doc = " ::cudaFree() returns ::cudaErrorInvalidDevicePointer in case of failure."]
    #[doc = ""]
    #[doc = " The device version of ::cudaFree cannot be used with a \\p *devPtr"]
    #[doc = " allocated using the host API, and vice versa."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " ::cudaMemcpy, ::cudaMemcpy2D, ::cudaMemcpyToArray,"]
...
extern "C" {
    ...
    #[doc = " \\note_sync"]
    #[doc = ""]
    #[doc = " \\sa ::cudaMemcpy2D, ::cudaMemcpyToArray,"]
    #[doc = " ::cudaMemcpy2DToArray, ::cudaMemcpyFromArray, ::cudaMemcpy2DFromArray,"]
    #[doc = " ::cudaMemcpyArrayToArray, ::cudaMemcpy2DArrayToArray, ::cudaMemcpyToSymbol,"]
    #[doc = " ::cudaMemcpyFromSymbol, ::cudaMemcpyAsync, ::cudaMemcpy2DAsync,"]
    #[doc = " ::cudaMemcpyToArrayAsync, ::cudaMemcpy2DToArrayAsync,"]
...
extern "C" {
    ...
    #[doc = " \\note_callback"]
    #[doc = ""]
    #[doc = " \\sa ::cudaMemcpy, ::cudaMemcpyToArray,"]
    #[doc = " ::cudaMemcpy2DToArray, ::cudaMemcpyFromArray, ::cudaMemcpy2DFromArray,"]
    #[doc = " ::cudaMemcpyArrayToArray, ::cudaMemcpy2DArrayToArray, ::cudaMemcpyToSymbol,"]
    #[doc = " ::cudaMemcpyFromSymbol, ::cudaMemcpyAsync, ::cudaMemcpy2DAsync,"]
    #[doc = " ::cudaMemcpyToArrayAsync, ::cudaMemcpy2DToArrayAsync,"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " \\sa ::cudaMemcpy, ::cudaMemcpy2D, ::cudaMemcpyToArray,"]
    #[doc = " ::cudaMemcpyFromArray, ::cudaMemcpy2DFromArray,"]
    #[doc = " ::cudaMemcpyArrayToArray, ::cudaMemcpy2DArrayToArray, ::cudaMemcpyToSymbol,"]
    #[doc = " ::cudaMemcpyFromSymbol, ::cudaMemcpyAsync, ::cudaMemcpy2DAsync,"]
    #[doc = " ::cudaMemcpyToArrayAsync, ::cudaMemcpy2DToArrayAsync,"]
    #[doc = " ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " \\sa ::cudaMemcpy, ::cudaMemcpy2D, ::cudaMemcpyToArray,"]
    #[doc = " ::cudaMemcpy2DToArray, ::cudaMemcpyFromArray,"]
    #[doc = " ::cudaMemcpyArrayToArray, ::cudaMemcpy2DArrayToArray, ::cudaMemcpyToSymbol,"]
    #[doc = " ::cudaMemcpyFromSymbol, ::cudaMemcpyAsync, ::cudaMemcpy2DAsync,"]
    #[doc = " ::cudaMemcpyToArrayAsync, ::cudaMemcpy2DToArrayAsync,"]
    #[doc = " ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,"]
...
extern "C" {
    ...
    #[doc = " \\sa ::cudaMemcpy, ::cudaMemcpy2D, ::cudaMemcpyToArray,"]
    #[doc = " ::cudaMemcpy2DToArray, ::cudaMemcpyFromArray, ::cudaMemcpy2DFromArray,"]
    #[doc = " ::cudaMemcpyArrayToArray, ::cudaMemcpyToSymbol,"]
    #[doc = " ::cudaMemcpyFromSymbol, ::cudaMemcpyAsync, ::cudaMemcpy2DAsync,"]
    #[doc = " ::cudaMemcpyToArrayAsync, ::cudaMemcpy2DToArrayAsync,"]
    #[doc = " ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,"]
    #[doc = " ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync,"]
...
extern "C" {
    ...
    #[doc = " \\sa ::cudaMemcpy, ::cudaMemcpy2D, ::cudaMemcpyToArray,"]
    #[doc = " ::cudaMemcpy2DToArray, ::cudaMemcpyFromArray, ::cudaMemcpy2DFromArray,"]
    #[doc = " ::cudaMemcpyArrayToArray, ::cudaMemcpy2DArrayToArray,"]
    #[doc = " ::cudaMemcpyFromSymbol, ::cudaMemcpyAsync, ::cudaMemcpy2DAsync,"]
    #[doc = " ::cudaMemcpyToArrayAsync, ::cudaMemcpy2DToArrayAsync,"]
    #[doc = " ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,"]
    #[doc = " ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync,"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Each device can support a system-wide maximum of eight peer connections."]
    #[doc = ""]
    #[doc = " Peer access is not supported in 32 bit applications."]
    #[doc = ""]
