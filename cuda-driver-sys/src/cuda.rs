...
pub type CUexecAffinitySmCount = CUexecAffinitySmCount_st;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub type CUexecAffinityParam = CUexecAffinityParam_st;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash, PartialOrd, Ord)]
...
pub type CUDA_EXT_SEM_SIGNAL_NODE_PARAMS = CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_st;
#[repr(C)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
...
pub type CUDA_EXT_SEM_WAIT_NODE_PARAMS = CUDA_EXT_SEM_WAIT_NODE_PARAMS_st;
...
pub type CUmemPoolProps = CUmemPoolProps_st;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub type CUmemPoolPtrExportData = CUmemPoolPtrExportData_st;
#[repr(C)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
...
extern "C" {
    pub fn cuMemAllocAsync(dptr: *mut CUdeviceptr, bytesize: usize, hStream: CUstream)
        -> CUresult;
}
extern "C" {
